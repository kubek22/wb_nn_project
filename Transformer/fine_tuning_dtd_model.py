...
def train_model(model, criterion, optimizer, train_loader, val_loader, test_loader, num_epochs):
    ...
    return train_loss_arr, train_acc_arr, val_loss_arr, val_acc_arr, test_loss_arr, test_acc_arr
...
train_loss_arr, train_acc_arr, val_loss_arr, val_acc_arr, test_loss_arr, test_acc_arr = train_model(model, criterion, optimizer, train_loader, val_loader, test_loader, EPOCHS)
...
save(train_loss_arr, 'output/fine_tuned_vit_pretrained_on_dtd_train_loss_arr')
save(train_acc_arr, 'output/fine_tuned_vit_pretrained_on_dtd_train_acc_arr')
save(val_loss_arr, 'output/fine_tuned_vit_pretrained_on_dtd_val_loss_arr')
save(val_acc_arr, 'output/fine_tuned_vit_pretrained_on_dtd_val_acc_arr')
save(test_loss_arr, 'output/fine_tuned_vit_pretrained_on_dtd_test_loss_arr')
save(test_acc_arr, 'output/fine_tuned_vit_pretrained_on_dtd_test_acc_arr')
